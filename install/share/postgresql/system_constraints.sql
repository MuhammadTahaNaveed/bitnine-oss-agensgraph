...
ALTER TABLE ag_graph ADD PRIMARY KEY USING INDEX ag_graph_oid_index;

ALTER TABLE ag_graph ADD UNIQUE USING INDEX ag_graph_graphname_index;

ALTER TABLE ag_label ADD PRIMARY KEY USING INDEX ag_label_oid_index;

ALTER TABLE ag_label ADD UNIQUE USING INDEX ag_label_labname_graph_index;

ALTER TABLE ag_label ADD UNIQUE USING INDEX ag_label_graph_labid_index;

ALTER TABLE ag_label ADD UNIQUE USING INDEX ag_label_relid_index;

ALTER TABLE ag_graphmeta ADD PRIMARY KEY USING INDEX ag_graphmeta_full_index;
